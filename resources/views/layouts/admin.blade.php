...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - NilaiQ</title>
    ...
    <!-- Meta tags for SEO -->
    <meta name="description" content="Portal Admin - Monitoring resource VPS dan sistem NilaiQ.">
...
<body class="font-sans antialiased bg-neutral-secondary-medium min-h-screen relative overflow-x-hidden">
    ...
    <div class="flex items-center gap-3 p-3 sm:hidden bg-neutral-primary-soft border-b border-default sticky top-0 z-30">
        ...
        <span class="text-lg font-bold text-heading">@yield('title', 'Admin')</span>
    </div>

    <!-- Sidebar Inclusion for Admin -->
