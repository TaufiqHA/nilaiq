   ...
   <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default flex flex-col justify-between">
         ...
         <div class="space-y-5">
            ...
            <div>
               ...
               <ul class="space-y-1 font-medium">
                  ...
                  <li>
                     <a href="{{ Route::has('wali-kelas.ekstrakurikuler') ? route('wali-kelas.ekstrakurikuler') : (Route::has('ekstrakurikuler.index') ? route('ekstrakurikuler.index') : '#') }}" class="flex items-center px-2 py-1.5 {{ request()->routeIs('ekstrakurikuler.*', 'wali-kelas.ekstrakurikuler.*') ? 'bg-neutral-tertiary text-fg-brand font-bold' : 'text-body hover:bg-neutral-tertiary hover:text-fg-brand' }} rounded-base group transition-all duration-200">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('ekstrakurikuler.*', 'wali-kelas.ekstrakurikuler.*') ? 'text-fg-brand' : 'group-hover:text-fg-brand' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div>
               ...
               <ul class="space-y-1 font-medium">
                  <li>
                     <a href="{{ Route::has('wali-kelas.daftar-hadir') ? route('wali-kelas.daftar-hadir') : (Route::has('attendance-meetings.index') ? route('attendance-meetings.index') : '#') }}" class="flex items-center px-2 py-1.5 {{ request()->routeIs('daftar-hadir.*', 'wali-kelas.daftar-hadir.*', 'attendance-meetings.*') ? 'bg-neutral-tertiary text-fg-brand font-bold' : 'text-body hover:bg-neutral-tertiary hover:text-fg-brand' }} rounded-base group transition-all duration-200">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('daftar-hadir.*', 'wali-kelas.daftar-hadir.*', 'attendance-meetings.*') ? 'text-fg-brand' : 'group-hover:text-fg-brand' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  ...
                  <li>
                     <a href="{{ Route::has('wali-kelas.catatan') ? route('wali-kelas.catatan') : (Route::has('catatan-wali-kelas.index') ? route('catatan-wali-kelas.index') : '#') }}" class="flex items-center px-2 py-1.5 {{ request()->routeIs('catatan-wali-kelas.*', 'wali-kelas.catatan.*') ? 'bg-neutral-tertiary text-fg-brand font-bold' : 'text-body hover:bg-neutral-tertiary hover:text-fg-brand' }} rounded-base group transition-all duration-200">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('catatan-wali-kelas.*', 'wali-kelas.catatan.*') ? 'text-fg-brand' : 'group-hover:text-fg-brand' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  ...
                  <li>
                     <a href="{{ Route::has('wali-kelas.nilai') ? route('wali-kelas.nilai') : (Route::has('nilai.index') ? route('nilai.index') : '#') }}" class="flex items-center px-2 py-1.5 {{ request()->routeIs('nilai.*', 'wali-kelas.nilai.*') ? 'bg-neutral-tertiary text-fg-brand font-bold' : 'text-body hover:bg-neutral-tertiary hover:text-fg-brand' }} rounded-base group transition-all duration-200">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('nilai.*', 'wali-kelas.nilai.*') ? 'text-fg-brand' : 'group-hover:text-fg-brand' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  ...
                  <li>
                     <a href="{{ Route::has('wali-kelas.rekap-nilai') ? route('wali-kelas.rekap-nilai') : (Route::has('rekap.index') ? route('rekap.index') : '#') }}" class="flex items-center px-2 py-1.5 {{ request()->routeIs('rekap-nilai.*', 'rekap.*', 'wali-kelas.rekap-nilai.*') ? 'bg-neutral-tertiary text-fg-brand font-bold' : 'text-body hover:bg-neutral-tertiary hover:text-fg-brand' }} rounded-base group transition-all duration-200">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('rekap-nilai.*', 'rekap.*', 'wali-kelas.rekap-nilai.*') ? 'text-fg-brand' : 'group-hover:text-fg-brand' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div>
               ...
               <ul class="space-y-1 font-medium">
                  <li>
                     <a href="{{ Route::has('settings-wali-kelas.index') ? route('settings-wali-kelas.index') : (Route::has('master-data.index') ? route('master-data.index') : '#') }}" class="flex items-center px-2 py-1.5 {{ request()->routeIs('settings-wali-kelas.*', 'wali-kelas.master-data.*', 'master-data.*') ? 'bg-neutral-tertiary text-fg-brand font-bold' : 'text-body hover:bg-neutral-tertiary hover:text-fg-brand' }} rounded-base group transition-all duration-200">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('settings-wali-kelas.*', 'wali-kelas.master-data.*', 'master-data.*') ? 'text-fg-brand' : 'group-hover:text-fg-brand' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <div class="border-t border-default pt-4 flex items-center justify-between gap-3">
         <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="min-w-0">
               <p class="text-sm font-bold text-heading truncate">{{ auth()->check() ? auth()->user()->name : 'Wali Kelas' }}</p>
               <p class="text-xs text-body truncate">{{ auth()->check() ? auth()->user()->email : 'walikelas@nilaiq.id' }}</p>
            </div>
         </div>
